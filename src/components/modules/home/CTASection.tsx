          ...
          <div className='grid grid-cols-1 gap-8 md:grid-cols-2 md:items-center'>
            <div>
              ...
              <p className='mt-4 text-white/90'>
                Join our community of passionate local guides and turn your
                knowledge into income. Share your favorite spots, hidden gems,
                and local stories with travelers from around the world.
              </p>
