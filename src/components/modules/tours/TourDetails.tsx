...
export default function TourDetails({ listing }: TourDetailsProps) {
  ...
  return (
    <div className='space-y-6'>
      ...
      {/* Map View */}
      {(listing?.meetingPoint || listing?.location) && (
        <Card>
          ...
          <div className='flex items-start gap-4'>
            ...
            <div className='flex-1'>
              ...
              <div className='mt-2 flex flex-wrap gap-2'>
                {(listing?.averageRating as number) >= 4.5 &&
                  (listing?.totalReviews as number) >= 10 && (
                    <span className='rounded-full bg-amber-100 px-3 py-1 text-xs font-semibold text-amber-700'>
                      Super Guide
                    </span>
                  )}
                {(listing?.totalReviews as number) < 3 && (
              ...
              <div className='mt-4'>
                ...
                {listing?.guide?.expertise &&
                listing?.guide?.expertise?.length > 0 ? (
                  <div className='mt-2 flex flex-wrap gap-2'>
              ...
              <div className='mt-4 grid grid-cols-2 gap-4'>
                <div className='rounded-lg bg-gray-50 p-3'>
                  <div className='text-lg font-bold'>
                    {listing?.guide?._count?.listings ?? 0}
                  </div>
                  <div className='text-sm text-gray-600'>Tours hosted</div>
                </div>
                <div className='rounded-lg bg-gray-50 p-3'>
                  <div className='text-lg font-bold'>
                    {listing?.guide?._count?.reviews ?? 0}
                  </div>
